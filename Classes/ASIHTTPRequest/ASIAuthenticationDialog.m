...
- (void)orientationChanged:(NSNotification *)notification
{
	...
	CGAffineTransform newTransform = CGAffineTransformMakeRotation(angle * (CGFloat)M_PI / 180.0f);
...
- (void)show
{
	...
	[self setTableView:[[(UITableView*)[UITableView alloc] initWithFrame:f style:UITableViewStyleGrouped] autorelease]];
