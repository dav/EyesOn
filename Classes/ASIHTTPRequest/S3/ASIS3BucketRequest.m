...
{
	ASIS3BucketRequest *request = [[(ASIS3BucketRequest*)[self alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://%@.s3.amazonaws.com",bucket]]] autorelease];
...
{
	ASIS3BucketRequest *request = [[(ASIS3BucketRequest*)[self alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://%@.s3.amazonaws.com/?%@",bucket,subResource]]] autorelease];
	[request setBucket:bucket];
